...
print("Test Statistic: {t_statistic:.2f}")
print("P-value: {p_value:.2f}")

# Define hypotheses
null_hypothesis = "The average response in the treatment group is the same as the average response in the control group."
alternative_hypothesis = "The average response in the treatment group is different from the average response in the control group."

print("\nHypotheses:")
print("Null Hypothesis (H0): {}".format(null_hypothesis))
print("Alternative Hypothesis (H1): {}".format(alternative_hypothesis))
